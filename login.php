...
<body>
    <div class="signin">
        ...
        <div class="form-section">
            <form action="config/loginproses.php" method="post" id="loginForm">
                <?php
                // Start the session
                session_start();
                ...
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <input class="mdl-textfield__input" type="email" id="email" name="email" oninput="validateInput(this)" required>
                ...
                <!-- Password -->
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <input pattern=".{8,}" class="mdl-textfield__input" type="password" id="password" name="password" oninput="validateInput(this)" required>
        ...
        <button type="submit" class="sign-in-btn mdl-button mdl-js-ripple-effect mdl-js-button mdl-button--raised mdl-button--colored" onclick="submitForm()">
            Sign In
        </button><!--/button-->
    </div><!--/.signin-->

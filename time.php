   ...
   <body id="inner_page">
                           ...
                           <div class="collapse navbar-collapse justify-content-md-center" id="cloapediamenu">
                              <ul class="navbar-nav">
                                 ...
                                 <li class="nav-item active">
                                    <a class="nav-link color-grey-hover" href="#">Detail</a>
                                 </li>
                                 <li class="nav-item">
                              ...
                              <ul class="navbar-nav">
                                 <li class="nav-item">
                                    <a class="nav-link" href="#"><img src="asset/images/search_icon.png" alt="#" /></a>
                                 </li>
                              </ul>
                           </div>
                        </nav>
      ...
      <section class="section blue_pattern_bg" style="background-color: #3b3bff;">
         <div class="container">
            <div class="row">
               <div class="col-md-6">
                  <div class="full">
                     <h4>brave your experience</h4>
                     <p>"College is not just about earning a degree; it's about refining <br>yourself into the best version you can be</p>
                  </div>
               </div>
               <div class="col-md-6">
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-4 col-sm-12">
                  <a href="index.php"><img class="img-responsive" src="asset/images/logo.png" alt="#" /></a>
                  <div class="footer_link_heading">
                     <div class="footer_menu margin_top_30">
                     <ul>
                        <li><a href="tel:9876543210">+62 882-7121-0820</a></li>
                        <li><a href="#">febriani@gmail.com</a></li>
                        <li><a href="#">Indonesia Bandung java</a></li>
                     </ul>
                  </div>
                  </div>
               </div>
      ...
      <div class="cpy">
        <div class="container">
           <div class="row">
             <div class="col-md-12">
               <p>Copyright by 21552011244<a href="Febriani">FEBRIANI TIF 221 PB</a></p>
             </div>
           </div>
        </div>
      </div>
